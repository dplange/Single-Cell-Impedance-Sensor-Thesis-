...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \caption{Depiction of chromium deposition at site of electrode delamination highlights failure of gold adhesion to chromium layer.}
    \end{subfigure}
    \\
    \vspace{0.1 in}
    \begin{subfigure}[b]{0.45\textwidth}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \caption{Gold elctrode strips sliding off chrome adhesions layer}
    \end{subfigure}
    \caption{Depictions of common electrode fabrication failures.}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{\textwidth}
        ...
        \caption{spice measured comp mag-phase}
    \end{subfigure}
    \\
    \vspace{0.1 in}
    \begin{subfigure}[b]{\textwidth}
        ...
        \caption{measured comp bode}
    \end{subfigure}
    \caption[measured comp]{measured comp}
    \label{fig:analytic_sensitivity}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Log log percent error plot.}
\end{figure}