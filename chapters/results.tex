...
\begin{figure}[h]
    ...
    \end{subfigure}
    \caption{The Clausius Mossotti factor varied over several medium conductivity values. All other parameters are given in table \ref{tab:}.}
...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{\textwidth}
        ...
        \caption{The imaginary part of the Clausius Mossotti factor.}
    \end{subfigure}
    \caption{The Clausius Mossotti factor varied over several medium permittivity values. All other parameters are given in table \ref{tab:}.}
