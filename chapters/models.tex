...
\label{sec: coplanarElectrodeCellConstant}
  ...
  \end{figure}
    ...
    \par A brief solution for the co-planar electrode system is covered in the following section with the complete step-by-step solution included in appendix \ref{app:conformal_mapping}.
