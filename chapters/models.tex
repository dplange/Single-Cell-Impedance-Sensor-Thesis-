...
\begin{figure}
    \centering
    \includegraphics[width =0.7\textwidth]{channel_dimensions_inventor}
    \caption{Caption}
    \label{fig:my_label}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{electrode_dimensions_inventor}
    \caption{Caption}
    \label{fig:my_label}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics{images/particle_dimension_inventor.png}
    \caption{Caption}
    \label{fig:my_label}
\end{figure}
