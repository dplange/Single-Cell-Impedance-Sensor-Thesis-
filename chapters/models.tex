...
\begin{figure}
    ...
    \caption{Analytic Impedance App}
    \label{fig:matlab_IS_app}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=0.45\textwidth]{images/impedanceControlsFrequency.png}
    \caption{Analytic Impedance App Frequency Controls}
    \label{fig:IS_app_frequency}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=0.45\textwidth]{images/impedanceControlsChamberGeoemetry.png}
    \caption{Analytic Impedance App Chamber Geometry Controls}
    \label{fig:IS_app_chamber_geometry}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=0.45\textwidth]{images/impedanceControlsCellGeometry.png}
    \caption{Analytic Impedance App Cell Geometry Control}
    \label{fig:analyticImpedanceCellGeometryControls}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=0.45\textwidth]{images/impedanceControlsDielectricProperties.png}
    \caption{Analytic Impedance App Dielectric Properties Controls}
    \label{fig:IS_app_dielectric_properties}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=0.45\textwidth]{images/impedanceControlsEDL.png}
    \caption{Analytic Impedance App EDL}
    \label{fig:IS_app_EDL}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=0.45\textwidth]{images/impedanceControlsPlotAndRun.png}
    \caption{Caption}
    \label{fig:IS_app_plot_run}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{images/impedanceDisplayMisc.png}
    \caption{Caption}
    \label{fig:my_label}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{images/impedanceDisplayEField.png}
    \caption{Caption}
    \label{fig:my_label}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
