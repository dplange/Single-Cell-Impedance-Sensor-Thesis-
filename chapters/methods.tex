...
\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{images/lift_off.jpg}
    \caption{Photoresist with metal depositions removed from glass substrate with Microposit remover 1165. The remaining metal deposition will form the }
