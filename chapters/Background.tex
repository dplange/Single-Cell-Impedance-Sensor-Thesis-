...
\end{equation}
 ...
 \par The application of impedance spectroscopy has a broad range from analysis of reaction kinetics, the study of batteries, to the research of biological samples. The general process of impedance spectroscopy involves the application of a voltage or current signal and the measurement of the signal response over a range of frequencies to obtain an impedance spectrum of the material. The resulting spectrum provides insight into the dielectric properties of the test material(s). 
 
 \par The system for measuring impedance is the I-V method (figure \ref{fig:IV_impedance_measurement}) The I-V method  
 ...
 \begin{figure}[ht]
    ...
    \caption[I-V impedance measurement method]{t}
    \label{fig:IV_impedance_measurement}
\end{figure}

 \begin{figure}[ht]
    \centering
    \includegraphics[width=0.7\textwidth]{images/RFIVMethod.png}
    \caption[RF I-V impedance measurement method]{t}
    \label{fig:RFIV_impedance_measurement}
\end{figure}

 \begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth]{images/autoBalancingBridge.png}
    \caption[Auto-balancing bridge impedance method]{t}
