...
\par Empirical recalculations involve fitting a reference measurement to a function or equivalent circuit. One of the more common equivalent circuits model the electric double layer as a resistor and capacitor in series (figure **) \cite{ishai-19}. The impedance of the system can be expressed as
