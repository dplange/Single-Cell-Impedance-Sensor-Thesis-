...
\end{equation}
 ...
 \par Electrorotation is the reaction of a polarized particle, assuming the particle has different dielectric properties than the medium, to a rotating electric field. Such a field can be created with a system of four electrodes with sinusoidal signals of 90\textdegree \;phase shifts between adjacent electrodes \cite{goater_electrorotation_1999}.
