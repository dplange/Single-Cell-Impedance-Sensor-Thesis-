...
\par The translation diffusion constant is a ration of Brownian motion and viscous resistance terms and can be generally expressed as 
...
\par When electric fields are applied to ionic solutions, the electrodes will attract ions of opposite charge. With equilibrium to Brownian forces, the applied field will result in the electric double layer (figure \ref{}) \cite{ishai_electrode_2013}.

\begin{figure}
    \centering
    \includegraphics{electr}
    \caption{Caption}
    \label{fig:my_label}
\end{figure}
