...
\end{equation}
 ...
 \begin{figure}[ht]
    \centering
    \includegraphics[width=0.7\textwidth]{images/ac_signal.png}
    \caption[Current Response of a system to an applied voltage]{Current Response of a system to a 1V applied voltage.}
    \label{fig:ac_signal}
 \end{figure}
