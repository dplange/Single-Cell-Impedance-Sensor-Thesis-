...
\end{equation}
 ...
 \par Electrical Impedance is defined as the opposition of a system to the flow of electrical current on a applied. If a sinusoidal voltage is applied to an arbitrary system, then the voltage and current can be expressed as
 \begin{equation}
    V(w) = |V|\cos(wt-\theta_V),
    \label{eqn:V(w)}
 \end{equation}
